        ...
        <Grid container spacing={4} alignItems="center" className={styles.heroSection}>
          <Grid item xs={12} md={6}>
            ...
            <Box className={styles.buttonGroup}>
              <Button onClick={handle} variant="contained" color="primary" className={styles.button}>
                Get Started
              </Button>
              <Button onClick={handle} variant="outlined" color="primary" className={styles.button}>
                Learn More
              </Button>
            </Box>
          </Grid>
